...
- **New commands** — e.g. `/llm-wiki:export`, `/llm-wiki:compare`, `/llm-wiki:archive`
...
Commands live in `.claude/commands/llm-wiki/`. Each file is a markdown prompt that Claude Code interprets as a slash command. When modifying:
